...
export default function ShepherdZipHoodie3SHPPage() {
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              {/* Product Title */}
              <div>
                <h1 className="text-3xl font-bold text-black uppercase tracking-wide mb-4">SHEPHERD ZIP HOODIE 3SHP</h1>
                <p className="text-gray-700 leading-relaxed">
                  {
                    "Stay warm and comfortable in any condition with our Urban Fit hoodie. Crafted from a 330gsm cotton/polyester fleece shell and a 340gsm lined shepherd fleece body, it delivers premium insulation without sacrificing breathability. The taffeta quilted sleeves provide extra warmth while maintaining easy movement, and the shepherd fleece-lined hood with a full-zip high collar offers added protection for your head and neck. Finished with an embroidery zipper for a refined touch."
                  }
                </p>
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <div className="w-8 h-8 bg-[#2C3E50] rounded-full"></div>
              ...
              <div className="pt-8 border-t border-gray-200">
                <p className="text-sm font-bold text-black uppercase tracking-wider">JBS SHEPHERD ZIP HOODIE 3SHP</p>
              </div>

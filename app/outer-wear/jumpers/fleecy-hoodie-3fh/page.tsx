...
export default function FleecyHoodie3FHPage() {
  const sizes = ["2XS", "XS", "S", "M", "L", "XL", "2XL", "3XL", "4XL", "5XL", "6/7XL", "8/9XL", "10/11XL", "12/13XL"]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex justify-center bg-transparent text-transparent">
              <div className="w-full flex items-center justify-center p-4 bg-transparent">
                <img
                  src="/images/3FH-fleecy-hoodie-grey.jpg"
                  alt="Fleecy Hoodie 3FH"
            ...
            <div className="space-y-8">
              {/* Product Title */}
              <div>
                <h1 className="text-3xl font-bold text-black uppercase tracking-wide mb-4">FLEECY HOODIE 3FH</h1>
                <p className="text-gray-700 leading-relaxed">
                  {
                    "Designed for everyday comfort, our Classic Fit hoodie is made from cotton-rich CVC fleece (310gsm) for a soft, durable feel. Featuring a fully lined hood, 2x2 rib cuffs and a rounded hem for a snug fit, plus a front kangaroo pocket for convenience. Available in solid colours (80% cotton, 20% polyester) and marle variations (Charcoal Marle: 54% polyester, 46% cotton; Black Marle: 58% cotton, 42% polyester). Customize your look with interchangeable drawcord colours (sold separately).\nExtended sizing available — 6/7XL & 8/9XL in Black or Navy; 10/11XL & 12/13XL in Black only.\n\n"
                  }
                </p>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-6 gap-3">
                  {/* Top row */}
                  <div className="w-8 h-8 bg-[#B8B8B8] rounded-full" title="13% Marle"></div>
                  <div className="w-8 h-8 bg-[#4B5320] rounded-full" title="Army"></div>
                  <div className="w-8 h-8 bg-black rounded-full" title="Black"></div>
                  <div className="w-8 h-8 bg-[#2F2F2F] rounded-full" title="Black Marle"></div>
                  <div className="w-8 h-8 bg-[#36454F] rounded-full" title="Charcoal"></div>
                  <div className="w-8 h-8 bg-[#696969] rounded-full" title="Graphite Marle"></div>

                  {/* Second row */}
                  <div className="w-8 h-8 bg-[#2C3539] rounded-full" title="Gunmetal"></div>
                  <div className="w-8 h-8 bg-[#000080] rounded-full" title="Navy"></div>
                  <div className="w-8 h-8 bg-[#DC143C] rounded-full" title="Red"></div>
                  <div className="w-8 h-8 bg-[#4169E1] rounded-full" title="Royal"></div>
                  <div className="w-8 h-8 bg-white border-2 border-gray-300 rounded-full" title="White"></div>
                </div>
              </div>
              ...
              <div className="pt-8 border-t border-gray-200">
                <p className="text-sm font-bold text-black uppercase tracking-wider">JBS FLEECY HOODIE 3FH</p>
              </div>

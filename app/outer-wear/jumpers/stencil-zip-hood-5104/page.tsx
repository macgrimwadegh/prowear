...
export default function StencilZipHood5104Page() {
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              {/* Product Title */}
              <div>
                <h1 className="text-3xl font-bold text-black uppercase tracking-wide mb-4">STENCIL ZIP HOOD 5104</h1>
                <p className="text-gray-700 leading-relaxed">
                  {
                    "A premium zip-up hoodie crafted from heavyweight 350gsm cotton-rich fleece for superior warmth and durability. Features a full-zip front closure, adjustable drawstring hood, and spacious kangaroo pocket for convenient storage. The ribbed cuffs and hem provide a comfortable, secure fit while maintaining the garment's shape. Perfect for layering or wearing as a standalone piece, this hoodie combines classic styling with modern comfort for both work and casual wear."
                  }
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <div className="w-8 h-8 bg-[#F5F5DC] rounded-full border-2 border-gray-300" title="Ecru"></div>
                  <div className="w-8 h-8 bg-black rounded-full" title="Black"></div>
                  <div className="w-8 h-8 bg-[#000080] rounded-full" title="Navy"></div>
                  <div className="w-8 h-8 bg-[#808080] rounded-full" title="Grey Marle"></div>
                </div>
              </div>
              ...
              <div className="pt-8 border-t border-gray-200">
                <p className="text-sm font-bold text-black uppercase tracking-wider">AS COLOUR STENCIL ZIP HOOD 5104</p>
              </div>

...
export default function StencilHood5102Page() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex justify-center bg-transparent text-transparent">
              <div className="w-full flex items-center justify-center p-4 bg-transparent">
                <img
                  src="/images/5102-stencil-hood-slate-blue.jpg"
                  alt="Stencil Hood 5102"
            ...
            <div className="space-y-8">
              {/* Product Title */}
              <div>
                <h1 className="text-3xl font-bold text-black uppercase tracking-wide mb-4">STENCIL HOOD 5102</h1>
                <p className="text-gray-700 leading-relaxed">
                  {
                    "This mid-heavy weight hoodie features a regular fit, crafted from 80% cotton and 20% recycled polyester anti-pill fleece. Complete with a lined hood, kangaroo pocket, and ribbed cuffs, it\'s preshrunk for lasting comfort."
                  }
                </p>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-8 gap-2">
                  ...
                  <div className="w-6 h-6 bg-[#F5F5DC] rounded-full" title="Cream"></div>
                  <div className="w-6 h-6 bg-[#D3D3D3] rounded-full" title="Light Grey"></div>
                  <div className="w-6 h-6 bg-[#A0A0A0] rounded-full" title="Taupe"></div>
                  <div className="w-6 h-6 bg-[#8B4513] rounded-full" title="Brown"></div>
                  <div className="w-6 h-6 bg-[#654321] rounded-full" title="Dark Brown"></div>
                  <div className="w-6 h-6 bg-[#800020] rounded-full" title="Burgundy"></div>
                  <div className="w-6 h-6 bg-[#B0C4DE] rounded-full" title="Light Blue Grey"></div>

                  {/* Second row */}
                  <div className="w-6 h-6 bg-[#5F8A8B] rounded-full" title="Slate Blue"></div>
                  <div className="w-6 h-6 bg-[#000080] rounded-full" title="Navy"></div>
                  <div className="w-6 h-6 bg-black rounded-full" title="Black"></div>
                  <div className="w-6 h-6 bg-[#556B2F] rounded-full" title="Olive Green"></div>
                  <div className="w-6 h-6 bg-[#006400] rounded-full" title="Dark Green"></div>
                  <div className="w-6 h-6 bg-[#E5E5E5] rounded-full" title="Light Grey 2"></div>
                  <div className="w-6 h-6 bg-[#808080] rounded-full" title="Medium Grey"></div>
                  <div className="w-6 h-6 bg-[#696969] rounded-full" title="Dark Grey"></div>

                  {/* Third row */}
                  <div className="w-6 h-6 bg-[#2F2F2F] rounded-full" title="Charcoal"></div>
                  <div className="w-6 h-6 bg-black border-2 border-white rounded-full" title="Black Premium"></div>
                </div>
              </div>
              ...
              <div className="pt-8 border-t border-gray-200">
                <p className="text-sm font-bold text-black uppercase tracking-wider">AS COLOUR STENCIL HOOD 5102</p>
              </div>

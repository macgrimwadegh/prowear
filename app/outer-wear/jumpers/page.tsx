  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <nav className="flex flex-col items-center justify-center w-full space-y-3 sm:space-y-4 px-4">
          ...
          <Link href="/" className="flex-shrink-0">
            <svg
              ...
              viewBox="0 0 570 50"
              className="h-6 sm:h-8 hover:opacity-80 transition-opacity md:h-8 w-96"
              fill="white"
            >
      ...
      <main className="px-4 sm:px-8 py-6 sm:py-8">
        <div className="grid grid-cols-2 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-12 max-w-6xl mx-auto">
          {/* Falcon Quarter Zip FL02 */}
          <Link
            href="/outer-wear/jumpers/falcon-quarter-zip-fl02"
          ...
          >
            <div className="aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden bg-white">
              <img
                src="/images/FL02-falcon-quarter-zip-black.jpg"
                alt="Falcon Quarter Zip FL02"
                className="w-full h-full object-contain"
              />
            </div>
            <h3 className="text-sm sm:text-lg font-bold text-black uppercase tracking-wide">FALCON QUARTER ZIP FL02</h3>
          </Link>

          {/* Shepherd Zip Hoodie 3SHP */}
          <Link
            href="/outer-wear/jumpers/shepherd-zip-hoodie-3shp"
            className="text-center block hover:opacity-80 transition-opacity"
          >
            <div className="aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden bg-white">
              <img
                src="/images/3SHP-shepherd-zip-hoodie-navy.jpg"
                alt="Shepherd Zip Hoodie 3SHP"
                className="w-full h-full object-contain"
              />
            </div>
          ...
          {/* Fleecy Hoodie 3FH */}
          <Link
            href="/outer-wear/jumpers/fleecy-hoodie-3fh"
            className="text-center block hover:opacity-80 transition-opacity"
          >
            <div className="aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden bg-white">
              <img
            ...
            <h3 className="text-sm sm:text-lg font-bold text-black uppercase tracking-wide">FLEECY HOODIE 3FH</h3>
          </Link>

          {/* Stencil Zip Hood 5104 */}
          <Link
            href="/outer-wear/jumpers/stencil-zip-hood-5104"
            className="text-center block hover:opacity-80 transition-opacity"
          >
            <div className="aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden bg-white">
              <img
                src="/images/5104-stencil-zip-hood-ecru.jpg"
                alt="Stencil Zip Hood 5104"
                className="w-full h-full object-contain"
              />
            </div>
            <h3 className="text-sm sm:text-lg font-bold text-black uppercase tracking-wide">STENCIL ZIP HOOD 5104</h3>
          </Link>

          {/* Stencil Hood 5102 */}
          <Link
            href="/outer-wear/jumpers/stencil-hood-5102"
            className="text-center block hover:opacity-80 transition-opacity"
          >
            <div className="aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden bg-white">
              <img
            ...
            <h3 className="text-sm sm:text-lg font-bold text-black uppercase tracking-wide">STENCIL HOOD 5102</h3>
          </Link>

          {/* Relax Faded Hood 5166 */}
          <Link
            href="/outer-wear/jumpers/relax-faded-hood-5166"
            className="text-center block hover:opacity-80 transition-opacity"
          >
            <div className="aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden bg-white">
              <img
                src="/images/5166-relax-faded-hood-powder.jpg"
                alt="Relax Faded Hood 5166"
                className="w-full h-full object-contain"
              />
            </div>
            <h3 className="text-sm sm:text-lg font-bold text-black uppercase tracking-wide">RELAX FADED HOOD 5166</h3>
          </Link>
        </div>
      </main>
    </div>

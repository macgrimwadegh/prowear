...
export default function RelaxFadedHood5166Page() {
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              {/* Product Title */}
              <div>
                <h1 className="text-3xl font-bold text-black uppercase tracking-wide mb-4">RELAX FADED HOOD 5166</h1>
                <p className="text-gray-700 leading-relaxed">
                  {
                    " A relaxed fit in mid-weight 320 GSM fabric—80% cotton and 20% recycled polyester fleece. Features include a pullover style, drop shoulder, kangaroo pocket, self-fabric lined hood, and garment dyed finish. Complete with sleeve cuff ribbing and a tear-out label for simplicity."
                  }
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <div className="w-8 h-8 bg-[#F5F5DC] rounded-full border border-gray-200" title="Faded Cream"></div>
                  <div
                    className="w-8 h-8 bg-[#E5E5E5] rounded-full border border-gray-200"
                    title="Faded Light Grey"
                  ></div>
                  <div className="w-8 h-8 bg-[#A0927D] rounded-full" title="Faded Brown"></div>
                  <div className="w-8 h-8 bg-[#B8C5D1] rounded-full" title="Faded Powder Blue"></div>
                  <div className="w-8 h-8 bg-[#8B8B8B] rounded-full border-2 border-black" title="Faded Grey"></div>
                  <div className="w-8 h-8 bg-[#3A3A3A] rounded-full" title="Faded Charcoal"></div>
                </div>
              </div>
              ...
              <div className="pt-8 border-t border-gray-200">
                <p className="text-sm font-bold text-black uppercase tracking-wider">AS COLOUR RELAX FADED HOOD 5166</p>
              </div>

...
export default function FalconQuarterZipFL02Page() {
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              {/* Product Title */}
              <div>
                <h1 className="text-3xl font-bold text-black uppercase tracking-wide mb-4">FALCON QUARTER ZIP FL02</h1>
                <p className="text-gray-700 leading-relaxed">
                  {
                    "Fabric:Fleece 320gsm - Cotton face 80%Cotton, 20%Polyester.\n\nDescription:A traditional fleecy sweat, self fabric collar with half front zip.\n\nSide pockets at side seams on adult's."
                  }
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-3">
                  ...
                  <div className="w-8 h-8 bg-[#36454F] rounded-full"></div>
                </div>
              </div>
              ...
              <div className="pt-8 border-t border-gray-200">
                <p className="text-sm font-bold text-black uppercase tracking-wider">JBS FALCON QUARTER ZIP FL02</p>
              </div>

...
export default function PodiumLayeredJacketPage() {
  const [selectedColor, setSelectedColor] = useState("navy")
  const [selectedSize, setSelectedSize] = useState("")

  const colors = [
    { name: "Navy", value: "navy", color: "#1e3a5f" },
        ...
        <nav className="flex flex-col items-center justify-center w-full space-y-3 sm:space-y-4 px-4">
          ...
          <Link href="/" className="flex-shrink-0">
            ...
            >
              ...
              <path d="M2.97,14.52c3.34-3.28,6.66-6.57,10.04-9.79.4-.38,1.2-.43,1.82-.43,11.25-.02,22.49-.08,33.73,0,5.88.05,11.6,1.05,16.75,4.13,9.18,5.48,9.36,16.76.25,22.35-2.3,1.41-4.95,2.43-7.58,3.04-3.28.76-6.7,1.19-10.08,1.25-8.95.16-17.91.1-26.86.01-1.66-.01-2.16.52-2.09,2.13.11,2.72.03,5.45.03,8.31H2.84c-.04-.8-.1-1.51-.1-2.20,0-5.43,0-10.85,0-16.28,0-2.59,0-2.6,2.52-2.6,14.19,0,28.38.05,42.56-.06,1.9-.02,3.84-.61,5.66-1.23,1.54-.54,2.56-1.98,2.14-3.56-.33-1.24-1.26-2.78-2.33-3.26-1.78-.79-3.9-1.12-5.88-1.14-13.98-.08-27.97-.05-41.97-.04h-2.13c-.12-.21-.22-.42-.34-.63" />
            </svg>
          </Link>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              {/* Product Title */}
              <div>
                <h1 className="text-3xl font-bold text-black uppercase tracking-wide mb-4">
                  PODIUM LAYERED JACKET 3WSH
                </h1>
                <p className="text-gray-700 leading-relaxed">
                  Experience ultimate versatility with our Podium Layered Jacket. Featuring advanced layering
                  technology, this jacket combines a water-resistant outer shell with breathable mesh lining for optimal
                  temperature regulation. The adjustable hood with drawstrings and secure zip pockets make it perfect
                  for active lifestyles, while the modern athletic fit ensures you look professional whether you're
                  training or commuting.
                </p>
              </div>
                ...
                <div className="grid grid-cols-4 gap-2">
                  {sizes.map((size) => (
                    <button
                      ...
                      className={`border py-2 px-4 text-center transition-colors font-medium ${
                        selectedSize === size
              ...
              <div className="pt-8 border-t border-gray-200">
                <p className="text-sm font-bold text-black uppercase tracking-wider">JBS PODIUM LAYERED JACKET</p>
              </div>

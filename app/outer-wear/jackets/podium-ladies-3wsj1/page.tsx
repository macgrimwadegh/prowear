...
export default function PodiumLadiesPage() {
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              {/* Product Title */}
              <div>
                <h1 className="text-3xl font-bold text-black uppercase tracking-wide mb-4">PODIUM LADIES 3WSJ1</h1>
                <p className="text-gray-700 leading-relaxed">
                  Designed specifically for the modern professional woman, this technical jacket combines style with
                  performance. Featuring a tailored feminine fit, water-resistant outer shell, and breathable mesh
                  lining for optimal comfort. The high collar design provides additional protection while maintaining a
                  sleek silhouette. Perfect for active professionals who demand both functionality and style in their
                  outerwear.
                </p>
              </div>
              ...
              <div className="pt-8 border-t border-gray-200">
                <p className="text-sm font-bold text-black uppercase tracking-wider">JBS PODIUM LADIES 3WSJ1</p>
              </div>

...
export default function SoftShellJacketPage() {
  ...
  const colors = [
    { name: "charcoal", value: "#4a4a4a", label: "Charcoal" },
    { name: "black", value: "#000000", label: "Black" },
    { name: "navy", value: "#1e3a5f", label: "Navy" },
  ]
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-black uppercase tracking-wide mb-2">
                  SOFT SHELL JACKET 3LJ
                </h1>
                <p className="text-gray-600 text-sm sm:text-base">
                  Professional soft shell jacket with full front zipper and high collar design. Made from technical
              ...
              {/* Color Selection */}
              <div>
                <h3 className="text-lg font-bold text-black uppercase tracking-wide mb-3">Color</h3>
              ...
              {/* Size Selection */}
              <div>
                <h3 className="text-lg font-bold text-black uppercase tracking-wide mb-3">Size</h3>
                <div className="grid grid-cols-4 gap-2">
                  {sizes.map((size) => (
                    <button
                      key={size}
                      onClick={() => setSelectedSize(size)}
                      className={`py-3 px-4 border text-sm font-medium transition-all duration-200 hover:border-black ${
                        selectedSize === size
              ...
              {/* Product Title Text */}
              <div>
                <p className="text-sm font-bold sm:text-sm text-black">JBS SOFT SHELL JACKET</p>
              </div>

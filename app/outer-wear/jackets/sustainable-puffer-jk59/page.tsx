...
function DropdownNavigationDark() {
  ...
  const workWearItems = [
    ...
    { name: "Traditional Workwear", href: "/work-wear/traditional-workwear" },
  ]
...
export default function SustainablePufferJK59Page() {
  const sizes = ["XS", "S", "M", "L", "XL", "2XL", "3XL", "4XL", "5XL", "7XL"]

  return (
    <div className="min-h-screen bg-white">
      {/* Header Navigation */}
      <header className="w-full py-6 bg-black mx-0 my-0 px-[311px]">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              {/* Product Title */}
              <div>
                <h1 className="text-3xl font-bold text-black uppercase tracking-wide mb-4">SUSTAINABLE PUFFER JK59</h1>
                <p className="text-gray-700 leading-relaxed">
                  {
                    "This ultralight insulated jacket is constructed using 70% certified recycled polyester, including a 400D recycled PET shell (56gsm) and 100gsm recycled PET insulation. The 230T taffeta lining offers smooth internal comfort, while the 3D cut design ensures a modern, streamlined fit. Features include a panel-cushioned collar for neck warmth, elasticated cuffs, chin guard zip closure, deep zip side pockets, and large internal mesh utility pockets. Wrinkle-resistant and built for performance layering, with an internal zip for embroidery access."
                  }
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-3">
                  ...
                  <div className="w-8 h-8 bg-[#000080] rounded-full"></div>
                </div>
              </div>
              ...
              <div className="pt-8 border-t border-gray-200">
                <p className="text-sm font-bold text-black uppercase tracking-wider">
                  WINNING SPIRIT SUSTAINABLE PUFFER JK59
                </p>
              </div>

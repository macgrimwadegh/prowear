...
export default function PodiumTechJacketPage() {
  const [selectedSize, setSelectedSize] = useState("")
  const [selectedColor, setSelectedColor] = useState("Royal")

  // Proper sizing hierarchy from 2XS to 5XL
  const sizes = ["2XS", "XS", "S", "M", "L", "XL", "2XL", "3XL", "4XL", "5XL"]

  // All 5 available colors with their hex values
  const colors = [
    { name: "Army", value: "Army", color: "#4a5d23" },
    { name: "Black", value: "Black", color: "#000000" },
    { name: "Charcoal", value: "Charcoal", color: "#36454f" },
    { name: "Navy", value: "Navy", color: "#1e3a5f" },
    { name: "Royal", value: "Royal", color: "#4169e1" },
  ]
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              {/* Product Title */}
              <div>
                <h1 className="text-sm sm:text-lg font-bold text-black uppercase tracking-wide mb-4">
                  PODIUM TECH JACKET 3TEJ
                </h1>
                <p className="text-gray-700 leading-relaxed">
                  Built for all-weather performance, the Podium Tech Jacket is crafted from a PU-coated 100% polyester
                  pongee shell with a textured finish. Featuring a 6000mm waterproof rating and fully seam-sealed
                  construction, it keeps you dry and protected in tough conditions. The microfleece-lined body provides
                  warmth, while taffeta-lined sleeves ensure easy layering and movement.
                </p>
              </div>
              ...
              <div className="pt-8 border-t border-gray-200">
                <p className="text-sm font-bold text-black uppercase tracking-wider">JBS PODIUM TECH JACKET</p>
              </div>

...
export default function HiVizPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="px-4 sm:px-8 py-6 sm:py-8">
        <div className="grid grid-cols-2 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-12 max-w-6xl mx-auto">
          {/* Cotton Back T-Shirt 6NNCS */}
          <Link
            href="/work-wear/hi-viz/cotton-back-tshirt-6nncs"
          ...
          {/* Quarter Zip 6HVPZ */}
          <Link
            href="/work-wear/hi-viz/quarter-zip-6hvpz"
            className="text-center block hover:opacity-80 transition-opacity"
          >
            <div className="aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden bg-white">
              <img
                src="/images/6HVPZ-quarter-zip-orange-navy.jpg"
                alt="Quarter Zip 6HVPZ"
                className="w-full h-full object-contain"
              />
            </div>
            <h3 className="text-sm sm:text-lg font-bold text-black uppercase tracking-wide">QUARTER ZIP 6HVPZ</h3>
          </Link>
        </div>
      </main>
    </div>

...
export default function CottonBackTshirt6NNCSPage() {
  const sizes = ["2XS", "XS", "S", "M", "L", "XL", "2XL", "3XL", "4XL", "5XL", "7XL"]

  return (
    <div className="min-h-screen bg-white">
      {/* Header Navigation */}
      <header className="w-full py-4 sm:py-6 bg-black mx-0 my-0 px-4 sm:px-8 lg:px-[311px]">
        <nav className="flex flex-col items-center justify-center w-full space-y-3 sm:space-y-4">
          ...
          <Link href="/" className="flex-shrink-0">
            <svg
              ...
              viewBox="0 0 570 50"
              className="h-5 sm:h-8 w-auto hover:opacity-80 transition-opacity max-w-[90vw]"
              fill="white"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="flex justify-center bg-transparent text-transparent">
              <div className="w-full flex items-center justify-center p-4 bg-transparent">
                <img
                  src="/images/6NNCS-cotton-back-tshirt-lime.jpg"
                  alt="Cotton Back T-Shirt 6NNCS"
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-black uppercase tracking-wide mb-4">
                  COTTON BACK TSHIRT 6NNCS
                </h1>
                <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
                  {
                    "This classic fit polo is made from a 170gsm cotton-rich micro mesh (55% cotton / 45% polyester), delivering comfort, durability, and high performance. Featuring JB's Dri™ moisture-wicking technology, it keeps you cool and dry in active conditions. Certified to AS 4399:2020 (UPF 50+) and compliant with AS/NZS 1906.4:2023 and AS/NZS 4602.1:2011 for Day Only wear. Finished with a chest pocket and pen insert, open sleeves, contrast striped collar, and easy-care, quick-dry fabric.\nNote: Size 6/7XL available in Lime/Navy only."
                  }
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-[#ADFF2F]" title="Hi-Viz Lime"></div>
                  <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-[#FF4500]" title="Hi-Viz Orange"></div>
                </div>
              </div>

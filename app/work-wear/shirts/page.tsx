...
export default function WorkwearShirtsPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="px-4 sm:px-8 py-6 sm:py-8">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-2xl sm:text-4xl font-bold text-black uppercase tracking-wide mb-8">WORKWEAR SHIRTS</h1>
          <p className="text-lg text-gray-600 mb-8">
            Our workwear shirts collection is coming soon. Check back for professional shirts designed for durability
            and comfort.
          </p>

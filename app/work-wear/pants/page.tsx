    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="px-4 sm:px-8 py-6 sm:py-8">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-2xl sm:text-4xl font-bold text-black uppercase tracking-wide mb-8">WORKWEAR PANTS</h1>
          <p className="text-lg text-gray-600 mb-8">
            Our workwear pants collection is coming soon. Check back for durable work pants designed for comfort and
            functionality.
          </p>
          <div className="grid grid-cols-2 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-12">

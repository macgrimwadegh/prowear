...
export default function FleeceWorkwearPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="px-4 sm:px-8 py-6 sm:py-8">
        <div className="grid grid-cols-2 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-12 max-w-6xl mx-auto">
          {/* Fleece Quarter Zip FL151 */}
          <Link
            href="/work-wear/traditional-workwear/workwear-quarter-zip-fl151"
          ...
          >
            <div className="aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden bg-white">
              <img
                src="/images/FL151-workwear-quarter-zip-navy.jpg"
                alt="Fleece Quarter Zip FL151"
          ...
          {/* Fleece Trade Hoodie 6CFH */}
          <Link
            href="/work-wear/traditional-workwear/trade-hoodie-6cfh"
            className="text-center block hover:opacity-80 transition-opacity"
          >
            <div className="aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden bg-white">
              <img
                src="/images/6CFH-trade-hoodie-olive-orange.jpg"
                alt="Fleece Trade Hoodie 6CFH"
                className="w-full h-full object-contain"
              />
            </div>
            <h3 className="text-sm sm:text-lg font-bold text-black uppercase tracking-wide">

        ...
        <nav className="flex flex-col items-center justify-center w-full space-y-3 sm:space-y-4 px-4">
          ...
          <Link href="/" className="flex-shrink-0">
            <svg
              ...
              className="h-6 sm:h-8 hover:opacity-80 transition-opacity md:h-7 w-96 text-white"
              fill="currentColor"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="aspect-square overflow-hidden rounded-md">
              <img
                ...
                alt="Volunteer smiling in Lorne Mountain to Surf T-shirt holding cups"
            ...
            <div className="aspect-square overflow-hidden rounded-md">
              <img
                ...
                alt="Volunteer handing a drink wearing Lorne Pier to Pub T-shirt"
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"
                loading="lazy"
              />
            </div>
            ...
            <div className="aspect-square overflow-hidden rounded-md">
              <img
                ...
                alt="Two participants smiling at the beach after Pier to Pub event"
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"
                loading="lazy"
              />
            </div>

            {/* Gallery Image 4 - Jan Juc Swim Shorts Beach Lifestyle */}
            <div className="aspect-square overflow-hidden rounded-md">
              <img
                src="/images/jan-juc-swim-shorts-beach.png"
                alt="Person wearing navy blue Jan Juc swim shorts at the beach with ocean in background"
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"
                loading="lazy"
              />
            </div>

            {/* Gallery Image 5 - Fairhaven SLSC Beach Towel (zoomed in on logo) */}
            <div className="aspect-square overflow-hidden rounded-md">
              <img
                src="/images/fairhaven-slsc-towel.png"
                alt="Fairhaven Surf Life Saving Club beach towel with blue and yellow stripes and circular logo"
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-300 scale-125"
                loading="lazy"
              />
            </div>

            {/* Gallery Image 6 - Anglesea Swimwear */}
            <div className="aspect-square overflow-hidden rounded-md">
              <img
                src="/images/anglesea-swimwear.png"
                alt="Person wearing green and white striped Anglesea swim briefs at the beach"
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"
                loading="lazy"
              />
            </div>

            {/* Gallery Image 7 - Embroidery Process */}
            <div className="aspect-square overflow-hidden rounded-md">
              <img
                src="/images/embroidery-process.jpg"
                alt="Behind-the-scenes embroidery process showing hand adjusting navy cap in embroidery machine with Pier to Pub logos"
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"
                loading="lazy"
              />
            </div>

            {/* Gallery Image 8 - Lorne Pier to Pub Cap */}
            <div className="aspect-square overflow-hidden rounded-md">
              <img
                src="/images/lorne-pier-to-pub-cap.jpg"
                alt="White Lorne Pier to Pub baseball cap with sponsor logos including Powercor Australia"
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-300 scale-125"
                loading="lazy"
              />
            </div>

            {/* Gallery Image 9 - Prowear Navy Caps */}
            <div className="aspect-square overflow-hidden rounded-md">
              <img
                src="/images/prowear-navy-caps.jpg"
                alt="Collection of navy blue caps with PROWEAR branded labels showing quality headwear products"
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"
                loading="lazy"
              />
            </div>

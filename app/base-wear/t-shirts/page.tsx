  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="px-4 sm:px-8 py-6 sm:py-8">
        <div className="grid grid-cols-2 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-12 max-w-7xl mx-auto">
          {/* Heavy Tee 5080 */}
          <Link
            href="/base-wear/t-shirts/heavy-tee-5080"
          ...
          >
            <div className="bg-gray-100 aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden">
              <img src="/images/5080-heavy-tee-white.jpg" alt="Heavy Tee 5080" className="w-full h-full object-cover" />
            </div>
            <h3 className="text-sm sm:text-lg font-bold text-black uppercase tracking-wide">HEAVY TEE 5080</h3>
          </Link>

          {/* Staple Tee 5001 */}
          <Link
            href="/base-wear/t-shirts/staple-tee-5001"
            className="text-center block hover:opacity-80 transition-opacity"
          >
            <div className="bg-gray-100 aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden">
              <img
                src="/images/5001-staple-tee-granite.jpg"
                alt="Staple Tee 5001 - Granite"
                className="w-full h-full object-cover"
              />
            </div>
            <h3 className="text-sm sm:text-lg font-bold text-black uppercase tracking-wide">STAPLE TEE 5001</h3>
          </Link>

          {/* Block Tubular Tee 5050T */}
          <Link
            href="/base-wear/t-shirts/block-tubular-tee-5050t"
            className="text-center block hover:opacity-80 transition-opacity"
          >
            <div className="bg-gray-100 aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden">
              <img
                src="/images/5050T-block-tee-walnut.jpg"
                alt="Block Tubular Tee 5050T - Walnut"
                className="w-full h-full object-cover"
              />
            </div>
            <h3 className="text-sm sm:text-lg font-bold text-black uppercase tracking-wide">BLOCK TUBULAR TEE 5050T</h3>
          </Link>

          {/* Stone Wash Heavy Tee 5085 */}
          <Link
            href="/base-wear/t-shirts/stone-wash-heavy-tee-5085"
            className="text-center block hover:opacity-80 transition-opacity"
          >
            <div className="bg-gray-100 aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden">
              <img
                src="/images/5085-stone-wash-heavy-tee-black.jpg"
                alt="Stone Wash Heavy Tee 5085 - Black Stone"
                className="w-full h-full object-cover"
              />
            </div>
          ...
          {/* Staple Faded Tee 5065 */}
          <Link
            href="/base-wear/t-shirts/staple-faded-tee-5065"
            className="text-center block hover:opacity-80 transition-opacity"
          >
            <div className="bg-gray-100 aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden">
              <img
                src="/images/5065-staple-faded-tee-blue.jpg"
                alt="Staple Faded Tee 5065 - Faded Blue"
                className="w-full h-full object-cover"
              />
            </div>
            <h3 className="text-sm sm:text-lg font-bold text-black uppercase tracking-wide">STAPLE FADED TEE 5065</h3>
          </Link>

          {/* Men's Tee 1HT */}
          <Link
            href="/base-wear/t-shirts/mens-tee-1ht"
            className="text-center block hover:opacity-80 transition-opacity"
          >
            <div className="aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden bg-white">
              <img
                src="/images/1HT-mens-tee-new.jpg"
                alt="Men's Tee 1HT - Olive"
                className="w-full h-full object-contain"
              />
            </div>
            <h3 className="text-sm sm:text-lg font-bold text-black uppercase tracking-wide">MEN'S TEE 1HT</h3>
          </Link>

          {/* Women's Tee 1LHT */}
          <Link
            href="/base-wear/t-shirts/womens-tee-1lht"
            className="text-center block hover:opacity-80 transition-opacity"
          >
            <div className="aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden bg-white">
              <img
                src="/images/1LHT-womens-tee-black.jpg"
                alt="Women's Tee 1LHT - Black"
                className="w-full h-full object-contain"
              />
            </div>
            <h3 className="text-sm sm:text-lg font-bold text-black uppercase tracking-wide">WOMEN'S TEE 1LHT</h3>
          </Link>

          {/* Kids Tee 1KT */}
          <Link
            href="/base-wear/t-shirts/kids-tee-1kt"
            className="text-center block hover:opacity-80 transition-opacity"
          >
            <div className="aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden bg-white">
              <img
                src="/images/1KT-kids-tee-gray.jpg"
                alt="Kids Tee 1KT - Gray Heather"
                className="w-full h-full object-contain"
              />
            </div>
            <h3 className="text-sm sm:text-lg font-bold text-black uppercase tracking-wide">KIDS TEE 1KT</h3>
          </Link>
        </div>
      </main>
    </div>

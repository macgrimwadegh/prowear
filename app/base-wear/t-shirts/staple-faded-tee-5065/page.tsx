...
export default function StapleFadedTee5065Page() {
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              {/* Product Title */}
              <div>
                <h1 className="text-3xl font-bold text-black uppercase tracking-wide mb-4">STAPLE FADED TEE 5065</h1>
                <p className="text-gray-700 leading-relaxed">
                  {
                    "Mid weight, 180 GSM, 28-singles, 100% combed cotton\nConstruction\nNeck ribbing, side seamed, neck seam twin needle stitch, shoulder to shoulder tape, double needle hems, preshrunk to minimise shrinkage"
                  }
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <div className="w-8 h-8 rounded-full bg-[#A39B8B]"></div>
                  <div className="w-8 h-8 rounded-full bg-[#C4A572] border-2 border-black"></div>
                  <div className="w-8 h-8 rounded-full bg-[#6B6B47]"></div>
                  <div className="w-8 h-8 rounded-full bg-[#C4969B]"></div>
                  <div className="w-8 h-8 rounded-full bg-[#A67C7C]"></div>
                  <div className="w-8 h-8 rounded-full bg-[#8FA5A5]"></div>
                  <div className="w-8 h-8 rounded-full bg-[#5C6B7A]"></div>
              ...
              <div className="pt-8 border-t border-gray-200">
                <p className="text-sm font-bold text-black uppercase tracking-wider">AS COLOUR STAPLE FADED TEE 5065</p>
              </div>

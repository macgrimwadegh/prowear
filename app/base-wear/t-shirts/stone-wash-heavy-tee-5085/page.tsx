...
export default function StoneWashHeavyTee5085Page() {
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  {
                    "Heavy weight, 220 GSM, 16-singles, 100% carded cotton\n\nDropped shoulders, side neck ribbing with twin stitching, stone wash finish with a worn look, side seamed, shoulder to shoulder tape, double needle hems, acid wash look, preshrunk to minimise shrinkage"
                  }
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <div className="w-8 h-8 rounded-full bg-[#808080]"></div>
              ...
              <div className="pt-8 border-t border-gray-200">
                <p className="text-sm font-bold text-black uppercase tracking-wider">
                  AS COLOUR STONE WASH HEAVY TEE 5085
                </p>
              </div>

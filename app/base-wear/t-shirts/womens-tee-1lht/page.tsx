...
export default function WomensTee1LHTPage() {
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              {/* Product Title */}
              <div>
                <h1 className="text-3xl font-bold text-black uppercase tracking-wide mb-4">WOMEN'S TEE 1LHT</h1>
                <p className="text-gray-700 leading-relaxed">
                  {
                    "This classic fit tee is made from 100% cotton in solid colours and constructed with a soft yet durable 165gsm ring-spun jersey knit. Featuring a shape-holding elastane rib crew neck and vertical side seams to reduce twisting, it delivers comfort with structural integrity. Certified to AS 4399:2020 for UPF protection.\nNote: Sizes 22 & 24 available in Black only. Size 6 available in Black and White."
                  }
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <div className="w-8 h-8 bg-black rounded-full" title="Black (UPF 50+)"></div>
                  <div className="w-8 h-8 bg-[#FF1493] rounded-full" title="Hot Pink (UPF 50+)"></div>
                  <div className="w-8 h-8 bg-[#000080] rounded-full" title="Navy (UPF 50+)"></div>
                  <div className="w-8 h-8 bg-white border-2 border-gray-300 rounded-full" title="White (UPF 15)"></div>
                </div>
              </div>
              ...
              <div className="pt-8 border-t border-gray-200">
                <p className="text-sm font-bold text-black uppercase tracking-wider">JBS WOMEN'S TEE 1LHT</p>
              </div>

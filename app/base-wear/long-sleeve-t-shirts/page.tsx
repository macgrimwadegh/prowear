...
export default function LongSleeveTShirtsPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="px-4 sm:px-8 py-6 sm:py-8">
        <div className="grid grid-cols-2 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-12 max-w-6xl mx-auto">
          ...
          <Link
            href="/base-wear/long-sleeve-t-shirts/quality-long-sleeve-tee-1ls"
          ...
          >
            <div className="aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden">
              <img
                ...
                alt="Quality Long Sleeve Tee 1LS - Royal Blue"

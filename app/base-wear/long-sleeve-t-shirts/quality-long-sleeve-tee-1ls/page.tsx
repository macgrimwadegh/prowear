...
export default function QualityLongSleeveTee1LSPage() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="flex justify-center bg-transparent text-transparent">
              <div className="w-full flex items-center justify-center p-4 bg-transparent">
                <img
                  src="/images/1LS-quality-long-sleeve-tee-royal.jpg"
                  alt="Quality Long Sleeve Tee 1LS"
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-black uppercase tracking-wide mb-4">
                  QUALITY LONG SLEEVE TEE 1LS
                </h1>
                <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
                  Premium quality long sleeve tee crafted from 100% combed cotton for superior comfort and durability.
                  Features reinforced seams, pre-shrunk fabric, and a classic fit that maintains its shape wash after
                  wash. Perfect for layering or wearing on its own.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-5 gap-3">
                  <div className="w-6 h-6 sm:w-8 sm:h-8 bg-white border-2 border-gray-300 rounded-full"></div>
                  ...
                  <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-[#228B22]"></div>
                  <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-[#FF8C00]"></div>
                  ...
                  <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-[#000080]"></div>
                  <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-[#800080]"></div>
                </div>
              </div>

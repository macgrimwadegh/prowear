...
export default function StretchPolo2STSPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="aspect-square relative rounded-lg overflow-hidden">
              <Image
                src="/images/2STS-stretch-polo-white.jpg"
                alt="Stretch Polo 2STS"
                fill
            ...
            <div className="space-y-8">
              <div>
                <h1 className="text-3xl font-bold text-black mb-4">COLOURS BY COTTON STRETCH POLO 2STS</h1>
                <p className="text-gray-600 text-lg leading-relaxed">
                  {
                    "A modern take on a classic, the Slim Fit Stretch Polo is crafted from a 95% cotton, 5% elastane blend with a 180gsm soft-touch stretch fabric for comfort and flexibility. Designed with a 3-button placket and reinforced side splits, it delivers a clean, tailored look that moves with you."
                  }
                </p>
              </div>
              ...
              {/* Color Selection */}
              <div>
                <h3 className="text-lg text-black mb-4 font-bold">COLOURS</h3>
                ...
                <div className="grid grid-cols-4 gap-3">
                  {sizes.map((size) => (
                    <button
                      ...
                      className={`py-3 px-4 text-center font-medium transition-all border-2 rounded-none ${
                        selectedSize === size
              ...
              <div className="border-t pt-8">
                <h3 className="text-black mb-4 font-bold">JBS STRETCH POLO 2STS</h3>

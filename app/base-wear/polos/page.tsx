...
export default function PolosPage() {
  const products = [
    {
      id: 1,
      name: "SIGNATURE POLO 210",
      image: "/images/210-signature-polo-grey.jpg",
      href: "/base-wear/polos/signature-polo-210",
    },
    {
      id: 2,
      name: "SIGNATURE LADIES 210",
      image: "/images/2LPS-signature-ladies-polo-musk.jpg",
      href: "/base-wear/polos/signature-ladies-210",
    },
    {
      id: 3,
      name: "STRETCH POLO 2STS",
      image: "/images/2STS-stretch-polo-white.jpg",
      href: "/base-wear/polos/stretch-polo-2sts",
    },
    {
      id: 4,
      name: "OTTOMAN POLO S20P",
      image: "/images/S20P-ottoman-polo-gunmetal.jpg",
      href: "/base-wear/polos/ottoman-polo-s20p",
    },
  ]
  ...
  return (
    <div className="bg-white">
      {/* Header */}
      <header className="w-full py-6 bg-black mx-0 my-0 px-4 sm:px-8 lg:px-[311px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
            {products.map((product) => (
              <Link
                key={product.id}
                href={product.href}
                className="group block bg-white rounded-lg overflow-hidden transition-all duration-300 border-0"
              >
                <div className="aspect-square relative overflow-hidden">
                  <Image src={product.image || "/placeholder.svg"} alt={product.name} fill className="object-contain" />
                </div>
                <div className="p-6">
                  <h3 className="text-lg transition-colors items-center text-center font-bold text-black">
                    {product.name}
                  </h3>
                </div>
              </Link>

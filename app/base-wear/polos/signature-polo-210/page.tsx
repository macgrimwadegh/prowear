...
export default function SignaturePolo210Page() {
  const colors = [
    { name: "White", value: "#FFFFFF", code: "WHI" },
    { name: "Aqua", value: "#00BFFF", code: "AQU" },
    { name: "Black", value: "#000000", code: "BLK" },
    { name: "Steel Blue", value: "#4682B4", code: "STB" },
    { name: "Bottle Green", value: "#006A4E", code: "BTG" },
    { name: "Charcoal", value: "#36454F", code: "CHA" },
    { name: "Gold", value: "#FFD700", code: "GLD" },
    { name: "Brown", value: "#8B4513", code: "BRN" },
    { name: "Hot Pink", value: "#FF69B4", code: "HPK" },
    { name: "Jade", value: "#00A86B", code: "JAD" },
    { name: "Kelly Green", value: "#4CBB17", code: "KGR" },
    { name: "Light Blue", value: "#ADD8E6", code: "LBL" },
    { name: "Maroon", value: "#800000", code: "MAR" },
    { name: "Navy", value: "#000080", code: "NAV" },
    { name: "Orange", value: "#FFA500", code: "ORA" },
    { name: "Lime Green", value: "#32CD32", code: "LGR" },
    { name: "Purple", value: "#800080", code: "PUR" },
    { name: "Red", value: "#FF0000", code: "RED" },
    { name: "Royal Blue", value: "#4169E1", code: "RBL" },
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="aspect-square relative overflow-hidden rounded-lg">
              <Image
                src="/images/210-signature-polo-grey.jpg"
                alt="Signature Polo 210"
                fill
            ...
            <div className="space-y-8">
              {/* Product Title */}
              <div>
                <h1 className="text-4xl font-bold text-black mb-6">SIGNATURE POLO 210</h1>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <p className="text-base leading-relaxed">
                    <span className="text-black">
                      Designed for durability and everyday wear, the Classic Fit Polo is made from a 65% polyester, 35%
                      cotton blend with 210gsm pique fabric that’s easy care and resists pilling. Featuring a knitted
                      collar, JB’s 3-button placket, and reinforced herringbone tape at the neck seam, it’s built for
                      lasting structure and comfort. The set-in sleeves with open cuffs and straight hem with reinforced
                      side splits ensure a relaxed, versatile fit. Plus, it complies with AS 4399:2020 for UPF
                      protection, making it ideal for work or leisure.
                    </span>
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-bold text-black">COLOURS</h3>
                <div className="grid grid-cols-5 gap-3">
                  {colors.map((color) => (
                    <button
                      key={color.code}
                      onClick={() => setSelectedColor(color.code.toLowerCase())}
                      className={`w-8 h-8 rounded-full border-2 transition-all duration-200 hover:scale-105 ${
                        selectedColor === color.code.toLowerCase() ? "border-black scale-105" : "border-gray-300"
                      }`}
              ...
              {/* Sizing Section */}
              <div className="space-y-4">
                <h3 className="text-lg font-bold text-black">SIZING</h3>
                <div className="grid grid-cols-4 gap-3 max-w-md">
                  {sizes.map((size) => (
                    <button
                      key={size}
                      onClick={() => setSelectedSize(size)}
                      className={`py-3 px-4 text-sm font-medium border-2 transition-colors ${
                        selectedSize === size
              ...
              {/* Product Code */}
              <div className="pt-4">
                <p className="text-sm font-bold text-black">JBS SIGNATURE POLO 210</p>
              </div>
            </div>
          </div>
        </div>

...
export default function SportsRipstopPage() {
  return (
      ...
      <main className="px-8 py-12 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div>
              <h1 className="text-3xl font-bold text-black mb-4 uppercase tracking-wide">SPORTS RIPSTOP CAP 4003</h1>
              <p className="text-gray-700 text-lg leading-relaxed">
                {"Sports Ripstop with Bee Hive Mesh and Towelling Sweatband"}
              </p>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-5 gap-3">
                ...
                <button
                  className="w-8 h-8 rounded-full border-2 border-gray-300 bg-gradient-to-r from-white to-gray-300 hover:border-black transition-colors"
                  title="White/Grey"
                ></button>
              </div>
            </div>
            ...
            <div className="border-t pt-8">
              <h3 className="text-lg font-bold text-black mb-4 uppercase tracking-wide">HEADWEAR PROFESSIONALS 4003</h3>
            </div>
          </div>
        </div>
      </main>

    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="px-4 sm:px-8 py-6 sm:py-8">
        <div className="grid grid-cols-2 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-12 max-w-7xl mx-auto">
          {/* Sports Ripstop Cap 4148 */}
          <Link
            href="/head-wear/caps/sports-ripstop-4148"
            className="text-center block hover:opacity-80 transition-opacity"
          >
            <div className="aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden">
              <img
                src="/images/4148-sports-ripstop-cap-cyan.jpg"
                alt="Sports Ripstop Cap 4148"
                className="w-full h-full object-contain"
              />
            </div>
            <h3 className="text-sm sm:text-lg font-bold text-black uppercase tracking-wide">SPORTS RIPSTOP CAP 4148</h3>
          </Link>

          {/* Twill Mesh Trucker 3995 */}
          <Link
            href="/head-wear/caps/twill-mesh-trucker-3995"
            className="text-center block hover:opacity-80 transition-opacity"
          >
            <div className="aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden">
              <img
            ...
            <h3 className="text-sm sm:text-lg font-bold text-black uppercase tracking-wide">TWILL MESH TRUCKER 3995</h3>
          </Link>

          {/* Sports Ripstop Cap 4003 */}
          <Link
            href="/head-wear/caps/sports-ripstop-4003"
            className="text-center block hover:opacity-80 transition-opacity"
          >
            <div className="aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden">
              <img
                src="/images/4003-sports-ripstop-cap-navy.png"
                alt="Sports Ripstop Cap 4003"
                className="w-full h-full object-contain"
              />
            </div>
            <h3 className="text-sm sm:text-lg font-bold text-black uppercase tracking-wide">SPORTS RIPSTOP 4003</h3>
          </Link>

          {/* Washed Chino Twill 4168 */}
          <Link
            href="/head-wear/caps/washed-chino-twill-4168"
            className="text-center block hover:opacity-80 transition-opacity"
          >
            <div className="aspect-square mb-3 sm:mb-4 flex items-center justify-center overflow-hidden">
              <img
            ...
            <h3 className="text-sm sm:text-lg font-bold text-black uppercase tracking-wide">WASHED CHINO TWILL 4168</h3>
          </Link>
        </div>
      </main>
    </div>

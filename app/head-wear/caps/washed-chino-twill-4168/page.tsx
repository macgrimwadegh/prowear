...
export default function WashedChinoTwillPage() {
  return (
      ...
      <main className="px-8 py-12 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex items-center justify-center bg-transparent">
            <img
              src="/images/4168-washed-chino-twill-cap-beige.png"
              alt="Washed Chino Twill 4168"
          ...
          <div className="space-y-8">
            ...
            <div>
              <h1 className="text-3xl font-bold text-black mb-4 uppercase tracking-wide">WASHED CHINO TWILL 4168</h1>
            ...
            <div>
              ...
              <div className="grid grid-cols-5 gap-3">
                ...
                ></button>
                <button
                  className="w-8 h-8 rounded-full border-2 border-gray-300 bg-yellow-700 hover:border-black transition-colors"
                  title="Clay"
                ></button>
                <button
                  className="w-8 h-8 rounded-full border-2 border-gray-300 bg-red-800 hover:border-black transition-colors"
                  title="Cranberry"
                ></button>
                <button
                ...
                ></button>
                <button
                  className="w-8 h-8 rounded-full border-2 border-gray-300 bg-orange-800 hover:border-black transition-colors"
                  title="Rust"
                ></button>
                <button
            ...
            <div className="border-t pt-8">
              <h3 className="text-lg font-bold text-black mb-4 uppercase tracking-wide">HEADWEAR PROFESSIONALS 4168</h3>
            </div>
          </div>
        </div>
      </main>

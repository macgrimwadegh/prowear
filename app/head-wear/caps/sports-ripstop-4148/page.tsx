...
const colors = [
  ...
  { name: "Cyan", value: "cyan", hex: "#00BFFF" },
  { name: "Gold", value: "gold", hex: "#FFD700" },
  { name: "Bright Green", value: "bright-green", hex: "#32CD32" },
  { name: "Navy", value: "navy", hex: "#000080" },
  { name: "Orange", value: "orange", hex: "#FF4500" },
  { name: "Hot Pink", value: "hot-pink", hex: "#FF1493" },
  { name: "Purple", value: "purple", hex: "#800080" },
  { name: "Red", value: "red", hex: "#DC143C" },
  { name: "Royal", value: "royal", hex: "#4169E1" },
  { name: "White", value: "white", hex: "#FFFFFF" },
]

const sizes = ["One Size"]

export default function SportsRipstop4148Page() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex justify-center bg-transparent text-transparent">
              <div className="w-full flex items-center justify-center p-4 bg-transparent">
                <img
                  src="/images/4148-sports-ripstop-cap-cyan.jpg"
                  alt={`Sports Ripstop Cap 4148 - ${colors.find((c) => c.value === selectedColor)?.name}`}
            ...
            <div className="space-y-8">
              {/* Product Title */}
              <div>
                <h1 className="text-3xl font-bold text-black uppercase tracking-wide mb-4">SPORTS RIPSTOP CAP 4148</h1>
                <p className="text-gray-700 leading-relaxed">
                  Premium 6-panel sports cap crafted from durable ripstop fabric. Features a structured crown, curved
                  visor, and adjustable closure for the perfect fit.
                </p>
                <p className="text-gray-700 leading-relaxed mt-2">
                  Ideal for sports, outdoor activities, and everyday wear. The ripstop construction ensures long-lasting
                  durability while maintaining a lightweight, comfortable feel.
                </p>
              </div>
                  ...
                  {colors.map((color) => (
                    <button
                      ...
                      className={`w-8 h-8 rounded-full border-2 transition-all duration-200 ${
                        selectedColor === color.value ? "border-gray-900" : "border-gray-300 hover:border-gray-500"
                      } ${color.value === "white" ? "shadow-inner" : ""}`}
              ...
              <div className="pt-8 border-t border-gray-200">
                <p className="text-sm font-bold text-black uppercase tracking-wider">HEADWEAR PROFESSIONALS 4148</p>
              </div>
